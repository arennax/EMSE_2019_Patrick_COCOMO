...
\title{Negative Results about Effort Estimation
}
...
\institute{Tianpei Xia,
Tim Menzies\at
              Department of Computer Science, North Carolina State University, Raleigh, NC, USA \\
              Email: txia4@ncsu.edu,  timm@ieee.org 
}
...
\keywords{Effort Estimation \and COCOMO \and Hyperparameter Tuning \and Regression Trees \and Sequential Model Optimization}
...
This paper is about a compatibility exploration and validation for ``ROME'', a hyperparameter tuning based approach of software effort estimation, which can be a new baseline method for software effort estimation research on effort dataset from both traditional waterfall style projects (e.g. COCOMO Projects) and new open source agile style projects (e.g. GitHub Projects).
...
\begin{figure}
\centerline{\includegraphics[width=1\textwidth]{water_grey.pdf}}
...
\begin{table}
\centerline{\includegraphics[width=1\textwidth]{cocomo_para.pdf}}
\caption{COCOMO-II attributes.}
\label{tbl:cparems}
\vspace{-0.6cm}
\end{table}
...
\begin{figure}
\centerline{\includegraphics[width=1\textwidth]{rome_grey.pdf}}
...
\begin{figure}
\centerline{\includegraphics[width=0.7\textwidth]{flash.pdf}}
...
{
\scriptsize
\noindent \begin{tabular}{p{1.5cm}llrc}
{\textbf{Rank}}& \textbf{Method} & \textbf{Med.} & \textbf{IQR}\\
 \hline
...
repeated our experiment in 20 times and applied statistical tests to remove spurious distinctions.
 ...
 this study suffers much less parameter bias than other studies.
